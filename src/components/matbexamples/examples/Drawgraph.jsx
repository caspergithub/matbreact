    ...
    return (
        <section className="width100">
            ...
            <Toggle>
                {({ on, toggle }) => (
                    <div className="refBtn">
                        <button onClick={toggle}>OPG4MAJ19</button>
                        {on && <div>
                            <h4>OPG4MAJ19</h4>
            ...
            <Toggle>
                {({ on, toggle }) => (
                    <div className="refBtn">
                        <button onClick={toggle}>OPG5MAJ18</button>
                        {on && <div>
                            <h4>OPG5MAJ18</h4>
                            <div className="imgDiv">
            ...
            <Toggle>
                {({ on, toggle }) => (
                    <div className="refBtn">
                        <button onClick={toggle}>OPG3JUN17</button>
                        {on && <div>
                            <h4>OPG3JUN17</h4>
                            <div className="imgDiv">
            ...
            <Toggle>
                {({ on, toggle }) => (
                    <div className="refBtn">
                        <button onClick={toggle}>OPG3MAJ16</button>
                        {on && <div>
                            <h4>OPG3MAJ16</h4>
                            <div className="imgDiv">
            ...
            <Toggle>
                {({ on, toggle }) => (
                    <div className="refBtn">
                        <button onClick={toggle}>OPG4MAJ15</button>
                        {on && <div>
                            <h4>OPG4MAJ15</h4>
                            <div className="imgDiv">
